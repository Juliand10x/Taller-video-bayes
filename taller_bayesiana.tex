...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/uber/uber_trace_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/uber/uber_forest_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{img/uber/uber_ppc_plot.png}

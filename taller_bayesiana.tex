...
Primero, analizamos nuestra variable objetivo (\textit{trips\_pool}). Encontramos que, en promedio, se completan 1,408 viajes compartidos por periodo, con una desviación estándar de $\approx 257$ viajes. Este es el comportamiento base que nuestros predictores deberán intentar explicar.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{eda_wait_time.png}
        \caption{Viajes según el tiempo de espera}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{eda_commute.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{uber_correlation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{uber_trace_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{uber_forest_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{uber_ppc_plot.png}
